...
public class T3_getAttribute_css {
    ...
    public static void main(String[] args) {
        ...
        if (DocuportContains.LOGO_DOCUPORT.equalsIgnoreCase(docuport)) {
            System.out.println("Expected logo text: " + DocuportContains.LOGO_DOCUPORT + ", matches actual logo text: " + docuport);
        } else {
            System.out.println("Expected logo text: " + DocuportContains.LOGO_DOCUPORT + ", DOES NOT MATCH actual logo text: " + docuport);
        }
